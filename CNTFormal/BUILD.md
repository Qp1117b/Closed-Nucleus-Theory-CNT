...
│   ├── LQG-CNT系统对比与万物统一框架.md    # 权威整合：LQG-CNT对比、电荷起源
│   ├── 质能方程与G的完整推导.md            # E=mc² + G + α 三合一推导
│   ├── 粒子物理历史探索.md               # v3.0→v3.1变迁、量子几何到粒子物理
│   ├── 质子闭合核物理图像.md              # 质子物理图像（v3.1历史状态）
│   ├── 闭合核理论.md                     # 哲学基础（已并入cnt_theory_paper.md §1.6）
│   ├── 闭合核理论：从量子几何到粒子物理.md  # 研究论文草稿（已归档于粒子物理历史探索.md）
│   ├── CNT_质能方程完整推导.md            # 质能方程推导（已归档于质能方程与G的完整推导.md）
│   ├── G的推导：非拟合的结构性预测.md     # G推导（已归档于质能方程与G的完整推导.md）
│   └── 附录A-α的严格推导.md              # α推导（已归档于质能方程与G的完整推导.md）
