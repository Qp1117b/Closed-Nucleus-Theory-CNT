...
> **最终本体论框架（已确认）**：CNT的场连续性归属、层级结构、量子化归属、与标准模型的根本分歧——参见 [LQG-CNT系统对比与万物统一框架.md](LQG-CNT系统对比与万物统一框架.md)（第九部分：CNT最终本体论，第十部分：自洽性审查与最终确认）。
...
> **所有卡西米尔效应变体的覆盖范围评估**：21类变体的系统性评估，包括U(1)覆盖、硬检验及规范群分类——参见 [所有卡西米尔效应的虚闭合核解释——覆盖范围评估.md](../docs/archive/所有卡西米尔效应的虚闭合核解释——覆盖范围评估.md)。
...
11. ✅ 最终本体论框架（已确认）：场连续性归属、层级结构、量子化归属声明——参见 [LQG-CNT系统对比与万物统一框架.md](LQG-CNT系统对比与万物统一框架.md) 第九部分（CNT最终本体论）、第十部分（自洽性审查与最终确认）
12. ✅ 卡西米尔效应的CNT推导：虚闭合核引力解释，a⁻⁴律量纲分析，真空灾难结构性消解——参见 [LQG-CNT系统对比与万物统一框架.md](LQG-CNT系统对比与万物统一框架.md) 第十一部分
13. ✅ 卡西米尔系数C₀的严格分解：C₀=π²/240=cot²θ·π²/16，几何因子cot²θ=1/15的严格推导——参见 [卡西米尔系数严格计算探索.md](../docs/archive/卡西米尔系数严格计算探索.md)
14. ✅ 引力耦合g_cm=c²/(15ℓ₀)的第一性原理推导——参见 [卡西米尔系数严格计算探索.md](../docs/archive/卡西米尔系数严格计算探索.md) 附录C
15. ✅ 虚闭合核真空引力效应的系统理论与实验研究——参见 [虚闭合核真空引力效应——理论与实验研究.md](../docs/archive/虚闭合核真空引力效应——理论与实验研究.md)
16. ✅ 宇宙学常数的CNT框架内推导：网络密度标度，Bootstrap残余曲率，质量转化效率η=0.0664（⚠️ 从Planck 2018观测反推，非CNT第一性原理预测）——参见 [虚闭合核真空引力效应——理论与实验研究.md](../docs/archive/虚闭合核真空引力效应——理论与实验研究.md) §4.4
17. ✅ 卡西米尔效应与真空灾难的统一CNT框架：同一根源的两张面孔——参见 [卡西米尔效应与真空灾难的统一CNT框架.md](../docs/archive/卡西米尔效应与真空灾难的统一CNT框架.md)
18. ✅ 所有卡西米尔效应变体的覆盖范围评估：21类系统性评估，规范群严格分类，确立U(1)_EM范围边界——参见 [所有卡西米尔效应的虚闭合核解释——覆盖范围评估.md](../docs/archive/所有卡西米尔效应的虚闭合核解释——覆盖范围评估.md)
