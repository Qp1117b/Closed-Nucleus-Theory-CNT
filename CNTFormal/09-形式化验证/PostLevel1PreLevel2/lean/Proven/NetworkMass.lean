...
/- ======================================================================
  ...
  一级量变质变给出 P = Nn = 3（三个产物通道，每个承载一个能量子）。
  这三个能量子被改造后成为网络中的流通子。
  假设闭合核的信息饱和贝肯斯坦界限：
    3 · ln 2 = α · (3√3/4)
  ...
  物理意义：
    ...
    这是 CNT 的又一个自洽性检验：
    几何（4-单纯形）+ 一级量变质变（P=3个能量子）→ α 被唯一确定。
  ======================================================================-/
...
/- ======================================================================
  ...
  ★ 符号约定 (2026) ★：
    ...
    电子是二级量变质变后的产物，不能用 m_e 标定 ℓ₀ 或 ν
